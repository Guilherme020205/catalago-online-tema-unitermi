...
-- AddForeignKey
ALTER TABLE "public"."productLine" ADD CONSTRAINT "productLine_idCategory_fkey" FOREIGN KEY ("idCategory") REFERENCES "public"."category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."corLine" ADD CONSTRAINT "corLine_productCapacityId_fkey" FOREIGN KEY ("productCapacityId") REFERENCES "public"."productCapacity"("id") ON DELETE SET NULL ON UPDATE CASCADE;
