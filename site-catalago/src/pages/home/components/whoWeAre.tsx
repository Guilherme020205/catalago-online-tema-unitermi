    ...
    <div>
      ...
      <div className="flex flex-row my-5 gap-10">
        <div className="flex flex-col w-[700px]">
          ...
          <p className="mb-2">
            A Unitermi é uma empresa inovadora no ramo de utilidades domésticas
            como garrafas térmicas, isotérmicos e utilidades. Atuamos neste
            mercado desde 2015, já realizamos muito e com o esforço e a
            dedicação do nosso time, queremos realizar ainda mais.
          </p>
      ...
      <div className="flex flex-row my-5 gap-10">
        ...
        <div className="flex flex-col w-[700px]">
          ...
          <p className="mb-2">
            ...
            produtos. Acreditamos que é nosso papel, como empresa, desenvolver e
            propor formas de preservar tudo que é bom, como a natureza e a
            sociedade.
          </p>
          <p className="mb-2">
            Estamos envolvidos em diversos projetos sociais de cunho educacional
            e solidário visando desenvolver comunidades e indivíduos
            conscientes.
          </p>
          <p className="mb-2">
