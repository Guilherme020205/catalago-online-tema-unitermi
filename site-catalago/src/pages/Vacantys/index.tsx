    ...
    <div className="flex flex-col m-5 md:m-20">
      ...
      <ul>
        {vacancies.map((vacancy) => (
          ...
          >
            <summary className="font-bold text-xl cursor-pointer">{vacancy.title}</summary>
            <div>
            ...
            <div className="flex flex-col items-center border-2 p-5 my-5 rounded-2xl w-max">
              ...
              <button onClick={() => navigate("/contatos")} className="bg-web-pink px-8 py-2 mt-2 rounded-2xl cursor-pointer hover:font-bold transition-all duration-700">Contato</button>
            </div>
          </details>
        ))}
      </ul>
